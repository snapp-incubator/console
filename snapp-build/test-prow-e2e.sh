...
SCREENSHOTS_DIR=snapp-frontend/gui_test_screenshots
...
# Add htpasswd IDP
oc apply -f ../snapp-frontend/integration-tests/data/htpasswd-secret.yaml
oc patch oauths cluster --patch "$(cat ../snapp-frontend/integration-tests/data/patch-htpasswd.yaml)" --type=merge
set +x
